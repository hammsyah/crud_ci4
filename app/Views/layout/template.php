...
<head>
    ...
    <!-- Datatables -->
    <link href="<?= base_url('/aset'); ?>/css/dataTables.bootstrap.min.css" rel="stylesheet">
    <link href="<?= base_url('/aset'); ?>/css/buttons.bootstrap.min.css" rel="stylesheet">
    <link href="<?= base_url('/aset'); ?>/css/fixedHeader.bootstrap.min.css" rel="stylesheet">
    <link href="<?= base_url('/aset'); ?>/css/responsive.bootstrap.min.css" rel="stylesheet">
    <link href="<?= base_url('/aset'); ?>/css/scroller.bootstrap.min.css" rel="stylesheet">
